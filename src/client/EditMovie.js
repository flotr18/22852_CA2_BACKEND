    ...
    axios.get('/movies/' + this.props.match.params.id)
      .then(response => {
        ...
        this.setState({
          ...
          american : response.data.american
        });
      })
      .catch(error => {
        console.log(error);
    ...
    return (
      <div className="is-fluid">
        ...
        <form onSubmit={this.handleSubmit}>
          <h2 className="title is-1 has-text-info has-text-weight-bold is-uppercase has-text-centered">Update {this.state.title} Movie</h2>
          <hr />
